...
INSERT INTO sector (id, name, is_active, created_by, date_joined) VALUES (1, 'A', True, 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d')); 
INSERT INTO sector (id, name, is_active, created_by, date_joined) VALUES (2, 'B', True, 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'));
INSERT INTO sector (id, name, is_active, created_by, date_joined) VALUES (3, 'C', True, 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'));
INSERT INTO sector (id, name, is_active, created_by, date_joined) VALUES (4, 'D', True, 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'));
INSERT INTO sector (id, name, is_active, created_by, date_joined) VALUES (5, 'E', True, 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'));

INSERT INTO user (id, password, is_superuser, username, first_name, last_name, email, is_staff, is_active, date_joined, dni, phone_number, user_type) 
