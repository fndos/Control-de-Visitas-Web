...
(1, 'NORTE', True, 'Alex Jordán', 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'), DATE_FORMAT(NOW(),'%Y-%m-%d')),
(2, 'CENTRO', True, 'Alex Jordán', 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'), DATE_FORMAT(NOW(),'%Y-%m-%d')),
(3, 'SUR', True, 'Alex Jordán', 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'), DATE_FORMAT(NOW(),'%Y-%m-%d')),
(4, 'PERIFERICOS', True, 'Alex Jordán', 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'), DATE_FORMAT(NOW(),'%Y-%m-%d')),
(5, 'DESCONOCIDOS', True, 'Alex Jordán', 'Alex Jordán', DATE_FORMAT(NOW(),'%Y-%m-%d'), DATE_FORMAT(NOW(),'%Y-%m-%d'));
