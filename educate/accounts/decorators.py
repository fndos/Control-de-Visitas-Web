...
def tutor_leader_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    '''
    Decorator for views that checks that the logged in user is a tutor_leader,
    redirects to the log-in page if necessary.
    '''
    actual_decorator = user_passes_test(
...
def tech_leader_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='accounts:login'):
    '''
    Decorator for views that checks that the logged in user is a tech_leader,
    redirects to the log-in page if necessary.
    '''
    actual_decorator = user_passes_test(
